import { unref, getCurrentScope, onScopeDispose, onMounted, nextTick, getCurrentInstance, toRef as toRef$1, readonly, customRef, ref, watch, watchEffect, computed, shallowRef, inject, onUnmounted, reactive, markRaw, defineComponent, h } from "vue";
function deserializeFunctions(r) {
  return Array.isArray(r) ? r.map(deserializeFunctions) : typeof r == "object" && r !== null ? Object.keys(r).reduce((t, n) => (t[n] = deserializeFunctions(r[n]), t), {}) : typeof r == "string" && r.startsWith("_vp-fn_") ? new Function(`return ${r.slice(7)}`)() : r;
}
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"Zc-Element","description":"Vue 3 component library","base":"/zc-element/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"nav":[{"text":"Home","link":"/"},{"text":"Get Started","link":"/get-started"},{"text":"Components","link":"/components/button"}],"sidebar":[{"text":"Guide","items":[{"text":"Get Started","link":"/get-started"}]},{"text":"Basic","items":[{"text":"Button","link":"/components/button"},{"text":"Icon","link":"/components/icon"}]},{"text":"Form","items":[{"text":"Input","link":"/components/input"},{"text":"Switch","link":"/components/switch"}]},{"text":"Feedback","items":[{"text":"Alert","link":"/components/alert"}]},{"text":"Data","items":[{"text":"Collapse","link":"/components/collapse"}]}],"socialLinks":[{"icon":"github","link":"https://github.com"}]},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
